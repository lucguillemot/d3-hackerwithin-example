d3.slider = function module() {
  ...
  var div, min = 0, max = 100, g1, g, value, classPrefix, axis, 
  height=40, rect,
  rectHeight = 12,
  tickSize = 6,
  ...
  slider.move = function(pos) {
    ...
    // Move dragger
    g1.selectAll(".dragger").data(values)
    .attr("transform", function(d) {
      return "translate(" + scale(d) + ")";
    });
    ...
    g1.selectAll(".dragger").select("text")
    .text(displayValue);
   
    if (range) { 
      g1.selectAll(".d3slider-rect-value")
      .attr("width", scale(value));
    }
